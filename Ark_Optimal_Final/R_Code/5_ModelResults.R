...
setwd("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/")
mod.no <- 25
mod <- out[[mod.no]]
...
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/OccuProb_maps.png", 
...
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/OccuProb_mapsALL_1.png",
...
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/OccuProb_mapsALL_2.png", width=850, height=1024)
trellis.par.set(strip.background=list(col="gray80"))
...
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/OccuProb_mapsALL_3.png", width=850, height=1024)
trellis.par.set(strip.background=list(col="gray80"))
...
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/OccuProbSD_mapsALL_1.png", width=850, height=1024)
trellis.par.set(strip.background=list(col="gray80"))
...
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/OccuProbSD_mapsALL_2.png", width=850, height=1024)
trellis.par.set(strip.background=list(col="gray80"))
...
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/OccuProbSD_mapsALL_3.png", width=850, height=1024)
trellis.par.set(strip.background=list(col="gray80"))
...
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/DetProb_maps.png", 
    width=850, height=1024)
...
#
# Maps for ALL species!!
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/DetProb_mapsALL_1.png", width=850, height=1024)
trellis.par.set(strip.background=list(col="gray80"))
...
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/DetProb_mapsALL_2.png", width=850, height=1024)
trellis.par.set(strip.background=list(col="gray80"))
...
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/DetProb_mapsALL_3.png", width=850, height=1024)
trellis.par.set(strip.background=list(col="gray80"))
...
# SD Maps for ALL species!!
png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/DetProbSD_mapsALL_1.png", width=850, height=1024)
spplot(predmaps.det, 20:25, colorkey=T, as.table=T, cex=0.8, layout=c(2, 3), 
       par.settings=list(fontsize=list(text=26)),
       col.regions = my.palette[c(1, 2, 3, 5, 7)], cuts=4)
dev.off()

png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/DetProbSD_mapsALL_2.png", width=850, height=1024)
spplot(predmaps.det, 26:31, colorkey=T, as.table=T, cex=0.8, layout=c(2, 3), 
       par.settings=list(fontsize=list(text=26)),
       col.regions = my.palette[c(1, 2, 3, 5, 7, 8)], cuts=4)
dev.off()

png("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/DetProbSD_mapsALL_3.png", width=850, height=1024)
...
for(n in 1:length(natives)){
  out.file <- paste("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/", natives[n], "table.tex", sep="")
...
sink("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/5_ModelResults/ExampleDetectProbsEF.tex")
