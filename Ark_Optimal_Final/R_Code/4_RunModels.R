...
set.seed(5000)
    ...
    cat("Mod ", i, "done!\n")
  save.image("/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/4_RunModels/ArkInSampleModels.RData") # save often in case it crashes
}
...
write.csv(inSample.stats, "/Volumes/CPW_Work/Optimum Sampling/Ark_Optimal_Final/Output_Files/4_RunModels/InSampleStats.csv", row.names=F)
